...
def main():
    ...
    #检测交易时候增加的内容
    # with open("../vocabulary/random_new_1.pkl","rb") as file:   
    ...
    for idx,entry in enumerate(data):
        ...
        if data_i % 32 == 0 :
            ...
            file_path = f"../tmp/test_new_1/test_embedding/tree_node_list{file_i}.pth"
    ...
    for idx,entry in enumerate(data_onehot):
        ...
        if data_i_onehot % 32 == 0 :
            file_path = f"../tmp/test_new_1/test_one_hot/one_hot_list{file_i_onehot}.pth"
            with open(file_path, "w") as file:
